...
import { SpotifyPlaylistLoaderData } from "~/routes/resources/spotify-playlists";
...
function LastViewed({ items }: { items: Item[] }) {
  const [selected, setSelected] = useState();

  return items.length > 0 ? (
    <div className="mt-8 space-y-2">
      <h2 className="text-left text-gray-800">Recently viewed playlists</h2>
      <Form
        reloadDocument
        method="post"
